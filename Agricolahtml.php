...
<head>
	<title>Insertar datos empleado agricola</title>
	<meta charset="UTF-8">
...
<!--Comenzamos la entrada de datos del Trabajador-->
  <h2>Trabajador Agricola</h2>
  <form action="Agricola.php" method=POST>  
   <p>Digite su cedula: <input name="cedc" type=number placeholder="Su cedula aqui" required />
   </p>
   
   	<p>Escoja al propietario de la finca por favor:
	 <select name="cedpro" size=1> 
...
?>
  ...
  <p>Escriba sus nombres por favor: <input name="nomc" type=text placeholder="Sus nombres aqui" required />
	</p>
  <p>Escriba sus apellidos por favor: <input name="apec" type=text placeholder="Sus apellidos aqui" required/ >
	</p>
  <p>Escriba su direccion por favor: <input name="dirc" type=text placeholder="Su direccion aqui" required />
	</p>
  <p>Escriba su numero telefonico por favor: <input name="telc" type=number placeholder="Su telefono aqui"/>
	</p>
  <p>Escriba su tipo de sangre por favor: (Ejemplo: A+, O-) <input name="rhc" type=text maxlength=2 placeholder="Su RH aqui"/>
	</p>
  <p>Escriba su edad por favor: <input name="edac" type=number placeholder="Su edad aqui"/>
	</p>
