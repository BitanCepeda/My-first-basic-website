...
<head>
	<title>Insertar datos empleado industrial</title>
	<meta charset="UTF-8">
...
<hr/>
  ...
  <h2>Trabajador Industrial</h2>
   <form action="Industrial.php" method=POST>  
   <p>Digite su cedula: <input name="cedin" type=number placeholder="Su cedula aqui"  required />
   </p>
...
?>
  ...
  <p>Escriba sus nombres por favor: <input name="nomin" type=text placeholder="Sus nombres aqui" required />
	</p>
  <p>Escriba sus apellidos por favor: <input name="apein" type=text placeholder="Sus apellidos aqui" required />
	</p>
  <p>Escriba su direccion por favor: <input name="dirin" type=text placeholder="Su direccion aqui" required />
	</p>
  <p>Escriba su numero telefonico por favor: <input name="telin" type=number placeholder="Su telefono aqui"/>
	</p>
  <p>Escriba su tipo de sangre por favor: (Ejemplo: A+, O-) <input name="rhin" type=text maxlength=2 placeholder="Su RH aqui"/>
	</p>
  <p>Escriba su edad por favor: <input name="edain" type=number placeholder="Su edad aqui"/>
	</p>
  <p>Escriba su correo electronico por favor: <input name="emain" type=email placeholder="Su correo electronico aqui"/>
	</p>
